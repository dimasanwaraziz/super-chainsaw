...
<body>
        ...
        <tr>
            ...
            <td style="width: 80%; vertical-align: top;">
                <ol style="padding-left: 20px; margin: 0; text-align: justify;">
                    ...
                    <li>Peraturan Menteri Keuangan Nomor 49/PMK.02/2023 tentang Standar Biaya Masukan Tahun Anggaran
                        2024;</li>
                    <li>Peraturan Sekretaris Jenderal Dewan Perwakilan Rakyat Republik Indonesia Nomor 1 Tahun 2024
                        tentang Perjalanan Dinas Sekretariat Jenderal;</li>
                </ol>
            </td>
        </tr>
    </table>
    ...
    <ol>
        ...
        <li>Kepala Biro Sumber Daya Manusia Aparatur</li>
    </ol>
